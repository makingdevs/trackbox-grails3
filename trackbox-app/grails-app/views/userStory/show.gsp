...
<html>
    ...
    <body>
        ...
        <div id="show-userStory" class="content scaffold-show" role="main">
            ...
            <f:display bean="userStory" />
            <g:form resource="${this.userStory}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.userStory}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
